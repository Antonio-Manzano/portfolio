...
with st.expander("Edulibreria | Estructuras de Datos Avanzadas en C++", expanded=True):
    ...
    with col2:
        ...
        st.link_button("Ver Código en GitHub", "https://github.com/Antonio-Manzano/algoritmos/tree/main/Edu-Librer%C3%ADa", use_container_width=True)
...
with st.expander("Iticritics | Diseño de Bases de Datos Relacionales (SQL)"):
    ...
    with col2:
        ...
        st.link_button("Ver Código en GitHub", "https://github.com/Antonio-Manzano/algoritmos/tree/main/ITICRITICS", use_container_width=True)
...
with st.expander("Flooded | Desarrollo Full Stack y Bases de Datos NoSQL"):
    ...
    with col2:
        st.info("Conceptos Clave:\n\n* MongoDB (NoSQL)\n* Creación de APIs\n* React.js")
        st.link_button("Ver Código en GitHub", "https://github.com/Antonio-Manzano/algoritmos/tree/main/flooded", use_container_width=True)
